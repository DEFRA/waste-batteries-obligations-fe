...
[![Security Rating](https://sonarcloud.io/api/project_badges/measure?project=DEFRA_waste-batteries-obligations-fe&metric=security_rating)](https://sonarcloud.io/summary/new_code?id=DEFRA_waste-batteries-obligations-fe)
[![Quality Gate Status](https://sonarcloud.io/api/project_badges/measure?project=DEFRA_waste-batteries-obligations-fe&metric=alert_status)](https://sonarcloud.io/summary/new_code?id=DEFRA_waste-batteries-obligations-fe)
[![Coverage](https://sonarcloud.io/api/project_badges/measure?project=DEFRA_waste-batteries-obligations-fe&metric=coverage)](https://sonarcloud.io/summary/new_code?id=DEFRA_waste-batteries-obligations-fe)
...
```bash
cd waste-batteries-obligations-fe
nvm use
```
...
> compatibility fEx: `docker build --platform=linux/arm64 --no-cache --tag waste-batteries-obligations-fe`

Build:

```bash
docker build --target development --no-cache --tag waste-batteries-obligations-fe:development .
```

Run:

```bash
docker run -p 3000:3000 waste-batteries-obligations-fe:development
```
...
```bash
docker build --no-cache --tag waste-batteries-obligations-fe .
```

Run:

```bash
docker run -p 3000:3000 waste-batteries-obligations-fe
```
...
[SonarCloud](https://sonarcloud.io/summary/new_code?id=DEFRA_waste-batteries-obligations-fe)
